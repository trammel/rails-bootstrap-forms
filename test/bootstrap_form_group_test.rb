...
class BootstrapFormGroupTest < ActionView::TestCase
  ...
  test "help messages for default forms" do
    expected = %{<div class="form-group"><label class="form-control-label required" for="user_email">Email</label><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /><small class="form-text text-muted">This is required</p></div>}
    assert_equivalent_xml expected, @builder.text_field(:email, help: 'This is required')
  end

  test "help messages for horizontal forms" do
    expected = %{<div class="form-group row"><label class="form-control-label col-sm-2 required" for="user_email">Email</label><div class="col-sm-10"><input class="form-control" id="user_email" name="user[email]" type="text" value="steve@example.com" /><small class="form-text text-muted">This is required</p></div></div>}
  ...
  test "help messages to look up I18n automatically" do
    expected = %{<div class="form-group"><label class="form-control-label" for="user_password">Password</label><input class="form-control" id="user_password" name="user[password]" type="text" value="secret" /><small class="form-text text-muted">A good password should be at least six characters long</p></div>}
  ...
  test 'form_group renders the "error" class and message corrrectly when object is invalid' do
    ...
    expected = %{<div class="form-group has-danger"><p class="form-control-static">Bar</p><div class="form-control-feedback">can&#39;t be blank, is too short (minimum is 5 characters)</span></div>}
    assert_equivalent_xml expected, output
  end
