...
class BootstrapFieldsTest < ActionView::TestCase
  ...
  test "password fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="form-control-label" for="user_password">Password</label><input class="form-control" id="user_password" name="user[password]" type="password" /><p class="text-muted">A good password should be at least six characters long</p></div>}
