...
class BootstrapFieldsTest < ActionView::TestCase
  ...
  test "password fields are wrapped correctly" do
    expected = %{<div class="form-group"><label class="form-control-label" for="user_password">Password</label><input class="form-control" id="user_password" name="user[password]" type="password" /><span class="help-block">A good password should be at least six characters long</span></div>}
